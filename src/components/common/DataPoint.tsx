  ...
  switch (position) {
    default:
      dataPointReturnValue = (
        ...
        <Card
          className={`${backgroundColours[colour]} flex h-full flex-col items-center justify-center`}
        >
          <CardHeader className="w-full p-0 text-center">
            <CardTitle className="font-josefin text-lg tracking-tighter text-black">
              {children}
            </CardTitle>
          </CardHeader>
          <CardContent className="p-0">
            <p className={`${textColours[colour]} ${dataSize[size]} font-noto`}>
              {dataValue}
            </p>
          </CardContent>
        </Card>
    ...
    case "left":
      dataPointReturnValue = (
        ...
        <Card
          className={`${backgroundColours[colour]} flex h-full flex-col items-center justify-center`}
        >
          <CardHeader className="w-full p-0 text-start">
            <CardTitle className="font-josefin text-lg tracking-tighter text-black">
              {children}
            </CardTitle>
          </CardHeader>
